    ...
    <div class="dashboard-nav">
        <div class="dashboard-inner">
            <ul data-submenu-title="Main Navigation">
                <li class="active"><a href="/dashboard"><i class="lni lni-dashboard mr-2"></i>Dashboard</a></li>
            ...
            <ul data-submenu-title="My Accounts">
                <li><a href="/profile"><i class="lni lni-user mr-2"></i>My Profile </a></li>
                <li><a href="/password"><i class="lni lni-lock-alt mr-2"></i>Change Password</a></li>
